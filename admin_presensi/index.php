...
<head>
  ...
  <title>Admin Panel I Presensi</title>
  <?php
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <!-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-importmhs">
                    <i class="nav-icon fas fa-file-excel"></i> Ekspor Excel
                  </button>
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-importmhs">
                    <i class="nav-icon fas fa-file-pdf"></i> Ekspor Pdf
                  </button> -->
    ...
    <div class="modal fade" id="modal-importmhs">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="impormhs.php" method="POST" id="import" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" id="id_klsmatkul" name="id_klsmatkul" class="form-control" value="<?= $id_klsmatkul; ?>" hidden>
              </div>
              <h6>Template Excel</h6>
              <a href="downloadmhs.php?filename=templatemhst.xls" class="btn btn-success btn-sm">
                <i class="nav-icon fas fa-file-excel"></i> Download
              </a>
            </div>
            <div class="modal-footer pull-right">
              <button type="submit" class="btn btn-danger" name="importmhs" style="background-color:#86090f"><i class="nav-icon fas fa-file-excel"></i>Import Data</button>
          </form>
        </div>
      </div>
      <!-- /.modal-content -->
